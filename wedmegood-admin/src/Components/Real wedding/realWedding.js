...
const RealWedding = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("http://localhost:3000/api/v1/realWedding/create", formData);
            if (res.status === 201) {
    ...
    const deletePhotographer = async (id) => {
        ...
        try {
            setLoading(true);
            const res = await axios.delete(`http://localhost:3000/api/v1/realWedding/delete/${id}`);
    ...
    const updateVenueData = async (id) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`http://localhost:3000/api/v1/realWedding/update/${id}`, formData, {
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <form className="mt-5">
                                    ...
                                    <div className="d-flex gap-3 mt-4">
                                        <div style={{ width: '100%' }}>
                                            <textarea type="text" className="form-control" placeholder="Details about my Wedding" style={{ width: "100%" }} value={realWeddingDes}
